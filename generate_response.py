...
async def lifespan(app: FastAPI):
    ...
    app.state.prompt = """You are a docbot that help users to understand more about Choreo Product usage by answering
